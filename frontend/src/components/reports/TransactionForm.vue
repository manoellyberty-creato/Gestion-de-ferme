    ...
    <div>
      ...
      >
        ...
        <optgroup label="Revenus">
          <option value="sale_animal">Vente d'animaux</option>
          <option value="sale_eggs">Vente d'œufs</option>
          <option value="sale_meat">Vente de viande</option>
          <option value="sale_feathers">Vente de plumes</option>
          <option value="sale_manure">Vente de fumier</option>
          <option value="subsidy">Subventions</option>
        ...
        <optgroup label="Dépenses">
          ...
          <option value="health">Santé animale</option>
          ...
          <option value="other_expense">Autres dépenses</option>
        </optgroup>
      </select>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const cleanData = {
      ...
      campaign: formData.value.campaign || undefined, // Ne pas envoyer de string vide
    }
